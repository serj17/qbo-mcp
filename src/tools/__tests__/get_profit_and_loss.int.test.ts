...
import { handleGetProfitAndLoss } from "../get_profit_and_loss.js";
...
describe.skipIf(skip)("get_profit_and_loss integration (sandbox)", () => {
  it("returns a report with a non-empty Rows block", async () => {
    ...
    const result = await handleGetProfitAndLoss(
