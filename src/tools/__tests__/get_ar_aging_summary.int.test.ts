...
import { handleGetArAgingSummary } from "../get_ar_aging_summary.js";
...
describe.skipIf(skip)("get_ar_aging_summary integration (sandbox)", () => {
  it("returns a report with Header and Rows", async () => {
    ...
    const result = await handleGetArAgingSummary(
