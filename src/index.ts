...
import { getApAgingSummaryTool } from "./tools/get_ap_aging_summary.js";
import { getArAgingSummaryTool } from "./tools/get_ar_aging_summary.js";
import { getGeneralLedgerTool } from "./tools/get_general_ledger.js";
import { getProfitAndLossTool } from "./tools/get_profit_and_loss.js";
...
async function runMcpServer(): Promise<void> {
  ...
  defineTool(server, { qbo, logger }, getProfitAndLossTool);
  defineTool(server, { qbo, logger }, getBalanceSheetTool);
  defineTool(server, { qbo, logger }, getArAgingSummaryTool);
  defineTool(server, { qbo, logger }, getApAgingSummaryTool);
  defineTool(server, { qbo, logger }, getGeneralLedgerTool);
